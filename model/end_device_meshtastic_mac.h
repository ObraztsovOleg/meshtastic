#ifndef END_DEVICE_MESHTASTIC_MAC_H
#define END_DEVICE_MESHTASTIC_MAC_H
 ...
 */
class EndDeviceMeshtasticMac : public MeshtasticMac
{
public:
  static TypeId GetTypeId (void);

  EndDeviceMeshtasticMac ();
  virtual ~EndDeviceMeshtasticMac ();
  ...
  */
   ...
   */
  void SetDeviceAddress (lorawan::LoraDeviceAddress address);
   ...
   */
  lorawan::LoraDeviceAddress GetDeviceAddress (void);
   ...
   */
  void ApplyNecessaryOptions (lorawan::LoraFrameHeader &frameHeader);
   ...
   */
  void ApplyNecessaryOptions (lorawan::LorawanMacHeader &macHeader);

  /**
   * Set the message type to send when the Send method is called.
   */
  void SetMType (lorawan::LorawanMacHeader::MType mType);

  /**
   * Get the message type to send when the Send method is called.
   */
  lorawan::LorawanMacHeader::MType GetMType (void);

  /**
   * Parse and take action on the commands contained on this FrameHeader.
   */
  void ParseCommands (lorawan::LoraFrameHeader frameHeader);
   ...
   */
  void OnRxParamSetupReq (Ptr<lorawan::RxParamSetupReq> rxParamSetupReq);
   ...
   * \param rxParamSetupReq The Parameter Setup Request
   */
  virtual void OnRxClassParamSetupReq (Ptr<lorawan::RxParamSetupReq> rxParamSetupReq);
   ...
   * \param frequency The channel's center frequency.
   */
  void AddLogicalChannel (Ptr<lorawan::LogicalLoraChannel> logicalChannel);
   ...
   * packet.
   */
  void AddMacCommand (Ptr<lorawan::MacCommand> macCommand);
...
protected:
   ...
   */
  lorawan::LoraDeviceAddress m_address;
   ...
   * cycle limitations.
   */
  Ptr<lorawan::LogicalLoraChannel> GetChannelForTx (void);
   ...
   */
  std::list<Ptr<lorawan::MacCommand> > m_macCommandList;
...
private:
   ...
   */
  std::vector<Ptr<lorawan::LogicalLoraChannel> > Shuffle (std::vector<Ptr<lorawan::LogicalLoraChannel> > vector);
...
#endif /* END_DEVICE_MESHTASTIC_MAC_H */
