#ifndef MESHTASTIC_MAC_H
#define MESHTASTIC_MAC_H
...
class MeshtasticMac : public Object
{
public:
   ...
   */
  Ptr<lorawan::LoraPhy> GetPhy (void);
  ...
  */
   ...
   */
  lorawan::LogicalLoraChannelHelper GetLogicalLoraChannelHelper (void);
   ...
   */
  void SetLogicalLoraChannelHelper (lorawan::LogicalLoraChannelHelper helper);
...
protected:
  ...
  */
   ...
   */
  lorawan::LogicalLoraChannelHelper m_channelHelper;
